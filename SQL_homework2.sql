...
where monthly_salary is null;
 ...
 from employees left join roles_employee on roles_employee.employee_id = employees.id
 ...
 select employees.employee_name, salary.monthly_salary
 from employees left join employee_salary on employee_salary.employee_id = employees.id
 left join salary on employee_salary.salary_id = salary.id
